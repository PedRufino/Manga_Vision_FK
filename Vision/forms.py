...
class MangasModelForm(forms.ModelForm):
    class Meta:
        model = mangas
        fields = ['title', 'author', 'release_Year', 'responsible_Group', 'genre', 'sinopse', 'capa', 'in_launch', 'Abandoned', 'finished']
...
class ContatoModelForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['assunto'].widget.attrs.update({'placeholder': 'Digite o assunto...'})
        self.fields['mensagem'].widget.attrs.update({'class': 'form-vision', 'placeholder': 'Digite sua mensagem...'})
