...
class VisionViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if title_manga:
            ...
            queryset = models.mangas.objects.filter(
                title__istartswith=title_manga
            )  # Pesquisa se a Letra ou palavara começar em Maiúsculas ou minúscula (Letra, Trecho ou Palavra)
